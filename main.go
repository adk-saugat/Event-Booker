...
func getEvents(context *gin.Context){
	...
	if err != nil{
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Couldnot fetch events. Try again later!"})
		return
	}
...
func createEvent(context *gin.Context){
	...
	if err != nil{
		context.JSON(http.StatusBadRequest, gin.H{"message": "Couldnot create event! try again later."})
		return
	}
